...
from .config import (
    QUEUE_FILE, LIKED_FILE, PLAYLISTS_FILE, HISTORY_FILE, SETTINGS_FILE,
    STATE_DIR, QUALITY_ORDER, AUTOPLAY_OFF, TAB_SEARCH,
)
from .models import Track, track_to_mono, mono_to_track
...
def load_settings() -> Dict[str, Any]:
    from .config import _default_downloads_dir
